...
version = menpowidgets.__version__
# The full version, including alpha/beta/rc tags.
release = menpowidgets.__version__
...
htmlhelp_basename = 'MenpoWidgetsdoc'
...
latex_documents = [
    ('index', 'MenpoWidgets.tex', u'MenpoWidgets Documentation',
     authors, 'manual'),
]
...
man_pages = [
    ('index', 'menpowidgets', u'MenpoWidgets Documentation',
     [authors], 1)
]
